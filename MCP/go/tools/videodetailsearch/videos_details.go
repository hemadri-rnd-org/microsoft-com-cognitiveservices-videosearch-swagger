...
func Videos_detailsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/videos/details%s", cfg.BaseURL, queryString)
		...
		var result models.VideoDetails
...
func CreateVideos_detailsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_videos_details",
		mcp.WithDescription("The Video Detail Search API lets you search on Bing and get back insights about a video, such as related videos. This section provides technical details about the query parameters and headers that you use to request insights of videos and the JSON response objects that contain them. For examples that show how to make requests, see [Searching the Web for Videos](https://docs.microsoft.com/azure/cognitive-services/bing-video-search/search-the-web)."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Videos_detailsHandler(cfg),
	}
}
