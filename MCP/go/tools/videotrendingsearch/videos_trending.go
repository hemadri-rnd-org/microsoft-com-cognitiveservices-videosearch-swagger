...
func Videos_trendingHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/videos/trending%s", cfg.BaseURL, queryString)
		...
		var result models.TrendingVideos
...
func CreateVideos_trendingTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Videos_trendingHandler(cfg),
	}
}
